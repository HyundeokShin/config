" ATP project vim script: Wed Apr 29, 2015 at 11:29 PM +0900.

let b:atp_MainFile = 'cv_13.tex'
let g:atp_mapNn = 0
let b:atp_autex = 1
...
let b:atp_XpdfServer = 'cv_13'
let b:atp_Viewer = 'open'
let b:TreeOfFiles = {}
let b:ListOfFiles = ['structure.tex']
let b:TypeDict = {'structure.tex': 'preambule'}
let b:LevelDict = {'structure.tex': 1}
