...
\documentclass[]{cv_10} % Add 'print' as an option into the square bracket to remove colors from this template for printing

\addbibresource{cv_10.bib} % Specify the bibliography file to include publications
