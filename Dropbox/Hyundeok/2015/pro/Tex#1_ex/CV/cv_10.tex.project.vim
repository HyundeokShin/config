" ATP project vim script: Wed Apr 29, 2015 at 10:49 PM +0900.

let b:atp_MainFile = 'cv_10.tex'
let g:atp_mapNn = 0
let b:atp_autex = 1
...
let b:atp_OutDir = '/Users/hdshin/Dropbox/Hyundeok/2015/pro/Latex_ex/CV'
let b:atp_OpenViewer = '1'
let b:atp_XpdfServer = 'cv_10'
let b:atp_Viewer = 'open'
let b:TreeOfFiles = {}
let b:ListOfFiles = ['bibliography.bib']
let b:TypeDict = {'bibliography.bib': 'bib'}
let b:LevelDict = {'bibliography.bib': 1}
