" ATP project vim script: Sun Apr 26, 2015 at 12:21 AM +0900.

let b:atp_MainFile = 'cv_3.tex'
let g:atp_mapNn = 0
let b:atp_autex = 1
...
let b:atp_LocalColors = ['linkcolor', 'shade', 'text1', 'headings']
