" ATP project vim script: Thu Apr 30, 2015 at 09:58 PM +0900.

let b:atp_MainFile = 'essay2.tex'
let g:atp_mapNn = 0
let b:atp_autex = 1
...
let b:atp_OutDir = '/Users/hdshin/Dropbox/Hyundeok/2015/pro/Latex_ex/LettersEssay'
let b:atp_OpenViewer = '1'
let b:atp_XpdfServer = 'essay2'
let b:atp_Viewer = 'open'
let b:TreeOfFiles = {}
let b:ListOfFiles = ['sample.bib']
let b:TypeDict = {'sample.bib': 'bib'}
let b:LevelDict = {'sample.bib': 1}
