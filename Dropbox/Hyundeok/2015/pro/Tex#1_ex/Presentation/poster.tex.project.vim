" ATP project vim script: Mon Apr 27, 2015 at 07:43 PM +0900.

let b:atp_MainFile = 'poster.tex'
let g:atp_mapNn = 0
let b:atp_autex = 1
...
let b:atp_LocalCommands = ['\compresslist', '\resrow{']
let b:atp_LocalEnvironments = []
let b:atp_LocalColors = ['maroon']
